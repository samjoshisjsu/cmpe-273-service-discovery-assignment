"""
Microservice B - Service Instance 2
Same as Service A but running on different port
Demonstrates multiple instances of the same service
"""
...
def register_with_registry():
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            print(f"[SERVICE-B] Registered with registry")
        else:
            print(f"[SERVICE-B] Registration failed: {response.status_code}")
...
def send_heartbeat():
    ...
    while True:
        ...
        try:
            ...
            if response.status_code == 200:
                print(f"[SERVICE-B] Heartbeat sent")
            else:
                print(f"[SERVICE-B] Heartbeat failed: {response.status_code}")
...
def greet():
    ...
    print(f"[SERVICE-B] Serving /greet")
